    ...
    dispatch_once(&onceToken, ^{
        testingPublicKeys = @[
            [[MTDatacenterAuthPublicKey alloc] initWithPublicKey:@"-----BEGIN RSA PUBLIC KEY-----\n"
             "MIIBCgKCAQEAuiM/FBcsUT211mc2SnFLrnS2rTauTEDzgwlHElTcHtd2Jh4cFroL\n"
             "2C8vAU0o7rGrToDbYa3jRq3QW5L88+sKkR0o5nntDylWVyXDhU5zmeI/a10HhP68\n"
             "UZfBDupAW5phnPnrNS2rd5LRlsPIXDdb9hNjqqyXX6s9hKwkfOsbYAdoUGbehjXS\n"
             "Pj+pIhHqlbrPZtEWvZUDjH6xQMdYbNjYflrBExIHoRDgzD3ZhmqjaJNKTPUh8Itl\n"
             "lUqwSzFEbWwUJX7kVW3fuaFpxJJ/a/WCJa/B4kGyv5W1h7hYPzHTAbFblkmbl1fm\n"
             "bYxvynbXf89XeyIXfWmbEXL4cltZLtuCqQIDAQAB\n"
             "-----END RSA PUBLIC KEY-----"]
        ];
